...
public class DriveBackToPosition extends CommandBase {
    ...
    public DriveBackToPosition(DriveSubsystem subsystem, double distance) {
    ...
    public void initialize() {
        ...
        this.initialPosition = m_driveSubsystem.GetPosition();
    }
    ...
    public boolean isFinished() {
        return m_driveSubsystem.GetPosition() <= initialPosition - Distance; //finish command if we have reached our final destination
    }
